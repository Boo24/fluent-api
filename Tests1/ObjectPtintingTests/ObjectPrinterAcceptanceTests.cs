...
namespace ObjectPrinting.Tests
{
	...
	public class ObjectPrinterAcceptanceTests
	{
	    ...
	    {
	        var printer = ObjectPrinter.For<Person>().ExcludeType<Person>().SetTypeSerialization(ctx => ctx.ForTarget<int>().Use(x=>x.ToString()+"!"));
	        var actualResult = printer.PrintToString(person);
	        var expectedResult = "Person\r\n" +
	                             "	Id = Guid\r\n" +
	                             "	Name = Alex\r\n" +
	    ...
	    {
            var person = new Person { Name = "Alex", Age = 19, Height = 190.4, Bla = new[]{1,2}};
